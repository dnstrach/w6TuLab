...
test('I can search Google', async () => {
    ...
    //search div doesn't have a name attribute - issue with dark mode?
    ...
    //why does searchBar.clear() not work
    await driver.findElement(By.name("q")).clear() 

    // Let's do another search!
    await driver.findElement(By.name("q")).sendKeys('Where the Crawdads Sing\n')
    ...
    await driver.findElement(By.name("q")).sendKeys(`Schitt's Creek\n`)
